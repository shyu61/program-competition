...
// 方針
// 逐次問題で逆順に処理した方が扱いやすいパターン
// 逆順に考えた時、残る空席の内、前からp[i]番目の位置が高速に求められれば良い
// 動的に変化する順序情報を取得したい場合はfenwicktreeが良い。全ての位置を1で初期化しておき、値を入れるたびに0に更新すれば、
// 累積和が前から何番目の空席かを表すので、二分探索と組み合わせれば求解できる
